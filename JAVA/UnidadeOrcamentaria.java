 ...
 * Source Class: UnidadeOrcamentaria <br>
 * @version generated on Tue Apr 18 15:42:57 BOT 2017 by kennedy
 */

public interface UnidadeOrcamentaria extends Classificador {

    /* ***************************************************
     * Property https://github.com/kennedyrs/orcamento-federal#temOrgao
     */
     
    /**
     * Gets all property values for the temOrgao property.<p>
     * 
     * @returns a collection of values for the temOrgao property.
     */
    Collection<? extends Orgao> getTemOrgao();

    /**
     * Checks if the class has a temOrgao property value.<p>
     * 
     * @return true if there is a temOrgao property value.
     */
    boolean hasTemOrgao();

    /**
     * Adds a temOrgao property value.<p>
     * 
     * @param newTemOrgao the temOrgao property value to be added
     */
    void addTemOrgao(Orgao newTemOrgao);

    /**
     * Removes a temOrgao property value.<p>
     * 
     * @param oldTemOrgao the temOrgao property value to be removed.
     */
    void removeTemOrgao(Orgao oldTemOrgao);
